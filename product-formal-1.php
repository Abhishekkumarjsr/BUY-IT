...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="products/formal/1.png" width="100%" id="MainImg" alt="">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="products/formal/1.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="products/formal/2.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="products/formal/3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
        ...
        <div class="single-pro-details">
            <form method="post" action="addToCart.php">
                <h6>Home / Formal</h6>
                <h4>Formal Collection New Morden Design</h4>
                <h2>₹3999.00</h2>
                <input type="hidden" name="product_name" value="Formal Collection New Morden Design">
                <input type="hidden" name="product_image" value="products/formal/1.png">
                <input type="hidden" name="product_price" value="3999.00">
            ...
            <p><strong>Product Name:</strong> Classic Three-Piece Cream Suit</p>
            <p><strong>Description:</strong> Elevate your formal ensemble with our classic three-piece cream suit.
                Crafted with precision and attention to detail, this timeless ensemble exudes sophistication and
                refinement. The jacket features a tailored fit with a notched lapel, adding a touch of elegance to your
                look. The accompanying vest adds versatility, allowing you to effortlessly transition from professional
                meetings to evening events. Paired with matching trousers, this suit offers a cohesive and polished
                appearance. Whether worn for a wedding, business conference, or special occasion, this cream suit is
                sure to make a lasting impression.</p>
            <p><strong>Key Features:</strong></p>
            <ul>
                <li>Premium quality fabric for durability and comfort</li>
                <li>Tailored fit for a sleek silhouette</li>
                <li>Notched lapel jacket for classic appeal</li>
                <li>Versatile three-piece design for added styling options</li>
                <li>Timeless cream color for a sophisticated look</li>
            </ul>
            ...
            <ul>
                ...
                <li>Wedding</li>
                <li>Gala Dinners</li>
                <li>Red Carpet Affairs</li>
            </ul>
            <p><strong>Available Sizes:</strong> S,M,L,XL,XXL</p>
            <p><strong>Care Instructions:</strong> Dry clean only</p>
            <p>Elevate your formal wardrobe with our classic three-piece cream suit and make a statement wherever you
                go.</p>
        </div>
    </section>
