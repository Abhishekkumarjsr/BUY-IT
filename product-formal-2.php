...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="products/formal/2.png" width="100%" id="MainImg" alt="">
        ...
        <div class="single-pro-details">
            <form method="post" action="addToCart.php">
                <h6>Home / Formal</h6>
                <h4>Formal Three-Piece Cream Suit With brown collar</h4>
                <h2>₹2999.00</h2>
                <input type="hidden" name="product_name" value="Formal Three-Piece Cream Suit With brown collar">
                <input type="hidden" name="product_image" value="products/formal/2.png">
                <input type="hidden" name="product_price" value="2999.00">
            ...
            <p><strong>Product Name:</strong> Formal Three-Piece Cream Suit With brown collar</p>
